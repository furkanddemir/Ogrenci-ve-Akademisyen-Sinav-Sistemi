...
namespace Proje_Ogrenci_Akademisyen.Entity
{
    ...
    public partial class TurkcellOgrenciSinavSistemiEntities : DbContext
    {
        public TurkcellOgrenciSinavSistemiEntities()
            : base("name=TurkcellOgrenciSinavSistemiEntities")
        {
        }
